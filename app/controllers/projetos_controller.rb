class ProjetosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @projeto.save
        format.html { redirect_to @projeto, notice: 'Projeto foi criado(a)' }
  ...
  def update
    respond_to do |format|
      if @projeto.update(projeto_params)
        format.html { redirect_to @projeto, notice: 'Projeto foi atualizado(a)' }
  ...
  def destroy
    @projeto.destroy
    respond_to do |format|
      format.html { redirect_to projetos_url, notice: 'Projeto foi excluído(a)' }
