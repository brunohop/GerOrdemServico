class OrdemServicosController < ApplicationController
  ...
  private
    ...
    def ordem_servico_params
      params.require(:ordem_servico).permit(:fiscalcontrato, :proj_id, :preposto, :resptecnico, :os, :data_inicio, :data_previsao, :data_fim, :situacao, :resp_requisitante, :tipo_os_id, :fator_atendimento, :ust_pago, :ust_glosa)
    end
end
