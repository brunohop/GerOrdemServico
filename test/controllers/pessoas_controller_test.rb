...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { id_pessoa_redmine: @pessoa.id_pessoa_redmine, pessoa: @pessoa.pessoa, vinculo: @pessoa.vinculo }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { id_pessoa_redmine: @pessoa.id_pessoa_redmine, pessoa: @pessoa.pessoa, vinculo: @pessoa.vinculo }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
